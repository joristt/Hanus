...
\section{Problem}
	...
	\begin{itemize}
		\item making it possible to put most Haskell expressions on the right hand side of a Janus statement. See section \ref{sec:methodology} for an explanation on why not every possible Haskell expression is allowed.
